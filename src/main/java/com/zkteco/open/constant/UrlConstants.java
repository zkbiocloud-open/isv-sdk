...
public class UrlConstants {
    ...
    // 萤石
    public static final String VIDEO_GET_ACCESS_TOKEN_YS = "/open/bmp/video/v1/ys/accessToken";
    public static final String VIDEO_ADD_DEVICE_YS = "/open/bmp/video/v1/ys/device/add";
